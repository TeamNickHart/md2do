...
Press `Cmd+Enter` (Mac) or `Ctrl+Enter` (Win/Linux) to toggle task completion:
...
5. Toggle completion with `Cmd+Enter`
...
**Problem:** Keyboard shortcut doesn't toggle task completion
