...
interface Task {
  ...
  // Extracted context
  project?: string;              // From folder structure (e.g., "divvy" from projects/divvy/)
...
### Tags
```markdown
- [ ] @nick Review PR #divvy #backend #urgent
```
...
**From file paths:**
```markdown
# File: ~/Documents/markdown/projects/divvy/sprint-notes.md
- [ ] Update API docs
  # project = "divvy"
...
md2do list --project=divvy
md2do list --person=jane-doe

# Filter by tags
md2do list --tag=urgent
md2do list --tag=divvy

# Path filters
md2do list --path=projects/divvy
...
md2do list --project=divvy --due=this-week
```
...
!! Review PR #423 (divvy)
   ...
   @nick #divvy #backend
   file:///Users/nick/Documents/markdown/projects/divvy/sprint-planning.md:4
  ...
  "tasks": [
    {
      ...
      "text": "Review PR #423",
      "completed": false,
      "file": "projects/divvy/sprint-planning.md",
      "line": 4,
      "project": "divvy",
...
- [ ] Parse project from folder structure (`projects/divvy/` → `divvy`)
